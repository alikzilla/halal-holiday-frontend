...
const BestServices = () => {
  return (
    <section className="w-full py-8 md:py-[40px] px-4 md:px-0">
      <Container>
        <section className="flex flex-col items-start gap-6 md:gap-8">
          ...
          <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            {/* Hotel */}
            <div
              className="relative z-1 h-[180px] sm:h-[200px] md:h-[250px] flex flex-col items-start justify-between bg-center bg-cover gap-3 p-4 md:p-5 rounded-lg"
              style={{
            ...
            >
              ...
              <div className="text-center py-1 px-2 md:py-2 md:px-3 rounded-lg bg-white">
                <Heading6 className="text-[#222222] text-xs md:text-sm">
                  Hotel
                </Heading6>
              </div>
              <Heading4 className="text-white text-base md:text-lg w-full md:w-[220px]">
                Find Your Perfect Stay
              </Heading4>
            </div>

            {/* Tour - Full height on larger screens */}
            <div
              className="relative z-1 h-[180px] sm:h-[420px] md:row-span-2 flex flex-col items-start justify-between bg-cover bg-center gap-3 p-4 md:p-5 rounded-lg sm:col-span-1 lg:col-span-1"
              style={{
            ...
            {/* Rent a Car - Spans 2 columns on larger screens */}
            <div
              className="relative z-1 h-[180px] sm:h-[200px] md:h-[250px] flex flex-col items-start justify-between gap-3 p-4 md:p-5 bg-center bg-cover rounded-lg sm:col-span-2 lg:col-span-2"
              style={{
            ...
            {/* Flights */}
            <div
              className="relative z-1 h-[180px] sm:h-[200px] md:h-[250px] flex flex-col items-start justify-between gap-3 p-4 md:p-5 bg-center bg-cover rounded-lg"
              style={{
            ...
            {/* Transfer */}
            <div
              className="relative z-1 h-[180px] sm:h-[200px] md:h-[250px] flex flex-col items-start justify-between gap-3 p-4 md:p-5 bg-cover bg-center rounded-lg"
              style={{
