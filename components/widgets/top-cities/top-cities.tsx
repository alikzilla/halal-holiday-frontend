...
const TopCities = () => {
  return (
    <section className="w-full py-6 md:py-[40px] px-4 md:px-0">
      <Container>
        <section className="flex flex-col items-start gap-6 md:gap-8">
          <article className="flex flex-col items-start gap-2 md:gap-[6px]">
            <Heading2 className="text-[#266462] text-2xl md:text-3xl lg:text-4xl">
              Top Cities
            </Heading2>
          ...
          <div className="relative z-1 w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
            {/* Istanbul */}
            <div
              className="relative z-1 h-[180px] sm:h-[200px] md:h-[250px] flex flex-col items-start justify-end bg-center bg-cover gap-3 p-4 md:p-5 rounded-lg"
              style={{
            ...
            >
              ...
              <Heading4 className="text-white text-lg md:text-xl w-full md:w-[220px]">
                Istanbul, Turkey
              </Heading4>
            </div>

            {/* Tokyo - Will be full width on mobile, then normal on larger screens */}
            <div
              className="relative z-1 h-[180px] sm:h-[420px] md:row-span-2 flex flex-col items-start justify-end bg-cover bg-center gap-3 p-4 md:p-5 rounded-lg sm:col-span-1 lg:col-span-1"
              style={{
            ...
            {/* New York - Full width on mobile, then spans 2 columns on larger screens */}
            <div
              className="relative z-1 h-[180px] sm:h-[200px] md:h-[250px] flex flex-col items-start justify-end gap-3 p-4 md:p-5 bg-center bg-cover rounded-lg sm:col-span-2 lg:col-span-2"
              style={{
            ...
            {/* Paris */}
            <div
              className="relative z-1 h-[180px] sm:h-[200px] md:h-[250px] flex flex-col items-start justify-end gap-3 p-4 md:p-5 bg-center bg-cover rounded-lg"
              style={{
            ...
            {/* Sydney */}
            <div
              className="relative z-1 h-[180px] sm:h-[200px] md:h-[250px] flex flex-col items-start justify-end gap-3 p-4 md:p-5 bg-cover bg-center rounded-lg"
              style={{
