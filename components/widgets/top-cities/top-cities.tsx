      ...
      <Container>
        <section className="flex flex-col items-start gap-8">
          ...
          <div className="w-full grid grid-cols-4 grid-rows-2 gap-4">
            ...
            {/* Tour */}
            <div
              className="col-span-1 row-span-2 flex flex-col items-start justify-end bg-cover bg-center gap-4 p-5 rounded-lg"
              style={{
            ...
            {/* Rent a Car */}
            <div
              className="col-span-2 row-span-1 flex flex-col items-start justify-end gap-4 p-5 bg-center bg-cover rounded-lg"
              style={{
            ...
            {/* Flights */}
            <div
              className="col-span-1 row-span-1 flex flex-col items-start justify-end gap-4 p-5 bg-center bg-cover rounded-lg"
              style={{
            ...
            {/* Transfer */}
            <div
              className="col-span-1 row-span-1 flex flex-col items-start justify-end gap-4 p-5 bg-cover bg-center rounded-lg"
              style={{
