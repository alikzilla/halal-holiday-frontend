...
import { Body2, Heading4, Heading3, Heading5 } from "@/components/common";
...
const HotelCardType2: React.FC<HotelCardType2> = ({
  ...
  return (
    <Link
      href={`/hotel/hotels/${id}`}
      className="w-full border border-[#F2F2F2] rounded-xl overflow-hidden shadow-sm flex p-2"
    >
      ...
      <div className="w-full flex items-start justify-between p-2">
        <div>
          ...
          <div className="mb-4">
            <Heading4 className="text-[#222] mb-2">{name}</Heading4>
        ...
        <div className="flex flex-col h-full justify-between">
          ...
          {/* Price section */}
          <div className="border-t border-[#F2F2F2] pt-3 text-right">
            <Body2 className="text-[#919191] mb-1">
              {duration}, {guests}
            </Body2>
