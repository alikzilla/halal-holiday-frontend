...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      data-slot="switch"
      className={cn(
        "peer data-[state=checked]:bg-[var(--primary)] data-[state=unchecked]:bg-[var(--input)] focus-visible:border-[var(--ring)] focus-visible:ring-[var(--ring)]/50 dark:data-[state=unchecked]:bg-[var(--input)]/80 inline-flex h-[1.15rem] w-8 shrink-0 items-center rounded-full border border-gray-300 shadow-xs transition-all outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props}
    >
