...
export { default as HotelReservationNavbar } from "./hotel-reservation/navbar";
export { default as PersonalInfo } from "./hotel-reservation/personal-info";
export { default as AddServices } from "./hotel-reservation/add-services";
export { default as Checkout } from "./hotel-reservation/checkout";
