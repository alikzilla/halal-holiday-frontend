...
const ActivitySearchBar = () => {
  ...
  const handleSearchSubmit = () => {
    ...
    router.push(`/activities/search?${queryParams.toString()}`);
  };
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="relative z-42">
            ...
            >
              ...
              />
              <div className="flex flex-col">
                <Heading6 className="text-[#ADADAD]">Activity Date</Heading6>
                <Heading6 className="text-[#4C4C4C]">
          ...
          <div className="relative z-42">
            ...
            >
              ...
              />
              <div className="flex flex-col">
                <Heading6 className="text-[#ADADAD]">Participants</Heading6>
                <Heading6 className="text-[#4C4C4C]">
                  {guests.adults + guests.children > 0
                    ? `${guests.adults + guests.children} people`
                    : "Add people"}
                </Heading6>
              </div>
            </div>
...
const Modal = ({
  ...
  const destinations = [
    { name: "Tbilisi, Georgia", description: "Cultural Activities" },
    { name: "Baku, Azerbaijan", description: "Adventure Activities" },
    { name: "Istanbul, Turkey", description: "Historical Activities" },
    { name: "Batumi, Georgia", description: "Water Activities" },
    { name: "London, UK", description: "Sightseeing Activities" },
  ];
      ...
      <div className="space-y-4">
        ...
        <div>
          <h3 className="font-medium mb-2">
            When do you want to do the activity?
          </h3>
